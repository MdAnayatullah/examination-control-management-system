...
<head>
    ...
    <title>Examination Control Management System</title>
...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container"><a class="navbar-brand"><img src="assets/img/logo.png" height="55px;" width="60px;"></a>
        <div align="center">
            <h3 align="center">Examination Control Management System,  Depertment Univ. Polytechnic</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/img6.jfif" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/Amu1.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/amuu.jpeg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/img7.jpeg" alt="Flower">
        </div>
    </div>
</div>
...
<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        <select id="select_semester" name="select_semester" class="list-group-item">
            ...
            <option value="1"> Diploma Engg. I   Year ( Semester I  )</option>
            <option value="2"> Diploma Engg. I   Year ( Semester II )</option>
            <option value="3"> Diploma Engg. II  Year ( Semester III)</option>
            <option value="4"> Diploma Engg. II  Year ( Semester IV )</option>
            <option value="5"> Diploma Engg. III Year ( Semester V  )</option>
            <option value="6"> Diploma Engg. III Year ( Semester VI )</option>
        </select>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">PROF. PARVEZ MUSTAJAB</h3>
                    <hr/>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">PROF. ARSHAD UMAR</h3>
                    <hr/>
                    <h4 align="center">Principal<br/>UNIVERSITY POLYTECHNIC</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/TPO.jpg" class="img-rounded"/>
                    <h3 align="center">PROF.MOHAMMAD MOHSIN KHAN</h3>
                    <hr/>
                    <h4 align="center">TPO<br/>UNIVERSITY POLYTECHNIC</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4><strong>Call:</strong> 123456789 </h4>
                <h4><strong>Email: </strong>amupoly123@gmail.com</h4>
            </div>
