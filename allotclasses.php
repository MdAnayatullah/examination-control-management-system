            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">ALLOTMENT
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href=addclassrooms.php>CLASSROOMS</a>
                        </li>
                    </ul>
                </li>
...
<form action="allotclasses.php" method="post" style="margin-top: 100px">
    ...
    <div align="center">
        <select name="course" class="list-group-item">
            ...
            ';
            <option value="1">Diploma 1st Year</option>
            <option value="2">Diploma 2nd Year</option>
            <option value="3">Diploma 3rd Year</option>
        </select>
    </div>
...
<div align="center">
    ...
    <table id=allotedclassroomstable>
        ...
        $q = mysqli_query(mysqli_connect("localhost", "root", "", "ttms"),
            "SELECT * FROM classrooms ");
        $courses = array('Diploma 1st Year', 'Diploma 2nd Year', 'Diploma 3rd Year');
        while ($row = mysqli_fetch_assoc($q)) {
            if ($row['status'] == 0)
                continue;
